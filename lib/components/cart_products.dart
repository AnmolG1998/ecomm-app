...
class _Cart_productsState extends State<Cart_products> {
  ...
  Widget build(BuildContext context) {
    return new ListView.builder(itemCount:Products_on_the_cart.length,itemBuilder: (context,index){
...
//===================this section is for product price=======================
            new Container(
              ...
              child:new Text("\$${cart_prod_price}",style: TextStyle(fontSize: 16.0,fontWeight: FontWeight.bold,color: Colors.red),),
            )
          ],
        ),
        trailing: new Column(
